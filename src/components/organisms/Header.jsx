        ...
        <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-3">
                <div
                    ...
                    <div>
                        <h1
                            className="text-2xl font-bold font-display bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">TaskFlow Pro
                                          </h1>
            ...
            <div className="flex items-center space-x-3">
                ...
                </motion.form> : <Button onClick={() => setShowQuickAdd(true)} className="hidden sm:flex">
                    <ApperIcon name="Plus" size={16} className="mr-2" />Quick Add
                                </Button>}
                <Button onClick={() => setShowQuickAdd(true)} size="sm" className="sm:hidden">
                    <ApperIcon name="Plus" size={16} />
                </Button>
            </div>
        </div>
